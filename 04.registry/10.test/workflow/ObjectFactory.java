 ...
 * generated in the workflow package. 
...
public class ObjectFactory {
    ...
    private final static QName _AddService_QNAME = new QName("http://workflow", "addService");
    private final static QName _GetServiceResponse_QNAME = new QName("http://workflow", "getServiceResponse");
    private final static QName _AddServiceResponse_QNAME = new QName("http://workflow", "addServiceResponse");
    private final static QName _GetService_QNAME = new QName("http://workflow", "getService");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: workflow
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://workflow", name = "addService")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://workflow", name = "getServiceResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://workflow", name = "addServiceResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://workflow", name = "getService")
