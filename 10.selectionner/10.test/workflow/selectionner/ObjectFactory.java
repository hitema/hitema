 ...
 * generated in the workflow.selectionner package. 
...
public class ObjectFactory {
    ...
    private final static QName _ExecstepResponse_QNAME = new QName("http://selectionner.workflow", "execstepResponse");
    private final static QName _Execstep_QNAME = new QName("http://selectionner.workflow", "execstep");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: workflow.selectionner
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://selectionner.workflow", name = "execstepResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://selectionner.workflow", name = "execstep")
